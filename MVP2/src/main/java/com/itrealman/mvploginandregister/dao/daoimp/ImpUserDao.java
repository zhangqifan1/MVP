package com.itrealman.mvploginandregister.dao.daoimp;
...
import com.itrealman.mvploginandregister.database.DBHelper;
...
//        Cursor cursor = database.rawQuery(sql, new String[]{name});
    ...
    public boolean isExist(String name) {
        database = dbHelper.getReadableDatabase();
        Cursor cursor = database.query(DBHelper.TABLENAME, null, DBHelper.COLNUMNAME + " = ? ", new String[]{name}, null, null, null);
